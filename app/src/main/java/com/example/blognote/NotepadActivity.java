...
import com.example.blognote.adapters.NotesAdapter;
import com.example.blognote.callbacks.MainActionModeCallback;
import com.example.blognote.callbacks.NoteEventListener;
import com.example.blognote.db.NotesDB;
import com.example.blognote.db.NotesDao;
import com.example.blognote.model.Note;
import com.example.blognote.utils.NoteUtils;
...
import static com.example.blognote.EditNoteActivity.NOTE_EXTRA_Key;

public class NotepadActivity extends AppCompatActivity implements NoteEventListener, Drawer.OnDrawerItemClickListener {
        ...
        SwitchDrawerItem switchDrawerItem = new SwitchDrawerItem()
                ...
                .withOnCheckedChangeListener(new OnCheckedChangeListener() {
                    ...
                    public void onCheckedChanged(IDrawerItem drawerItem, CompoundButton buttonView, boolean isChecked) {
                        ...
                        TaskStackBuilder.create(NotepadActivity.this)
                                .addNextIntent(new Intent(NotepadActivity.this, MainActivity.class))
