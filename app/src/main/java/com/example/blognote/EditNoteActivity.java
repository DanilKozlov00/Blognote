...
public class EditNoteActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // set theme
        SharedPreferences sharedPreferences = getSharedPreferences(NotepadActivity.APP_PREFERENCES, Context.MODE_PRIVATE);
        int theme = sharedPreferences.getInt(NotepadActivity.THEME_Key, R.style.AppTheme);
        setTheme(theme);
